        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/profile/create') }}" class="btn btn-success btn-sm" title="Add New info">
                            ...
                            <table class="table">
                                ...
                                @foreach($profile as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset($item->photo) }}" width= '50' height='50' class="rounded-circle img-responsive" />
